...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/noticias_recepcion-touchscreen.jpg" class="images_top">
					<div class="content_text">
						<h1>Recepción por Touch Screen</h1>	
						<p>Para su rápida y confortable recepción aconsejamos hacer uso de las touch screen (pantallas táctiles) ubicadas en el hall de entrada de cada clínica. </p>
						<p>Simplemente debe ingresar su documento de identidad, confirmar su asistencia y dirigirse al sector de la clínica que le indica, no siendo necesario dirigirse a la recepción.</p>
                    </div><!-- content text -->		
			</div><!-- content page -->
