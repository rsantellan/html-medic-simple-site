...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/noticias_mp-verano.jpg" class="images_top">
					<div class="content_text">
						<h1>Capturá  tus momentos  más lindos: #MPVerano</h1>	
						<p>El verano sigue y queremos ver tus fotos para disfrutarlo juntos! Participá de nuestro concurso de Instagram publicando una foto que haga alusión a lo lindo de esta estación y etiquetala con el hashtag #MPVerano. </p>
						<p>Podés ganarte un drone!</p>
						<p><a href="descargas/BasesyCondicionesMPInstagram-2016.pdf" target="_blank">Ver Bases y condiciones</a>.</p>
                    </div><!-- content text -->		
			</div><!-- content page -->
