...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/noticias_cancelacion-de-consultas.jpg" class="images_top">
					<div class="content_text">
				    <h1>Cancelación de consultas</h1>	
				    <p>Para una mayor eficiencia del servicio y beneficio de otros socios es importante cancelar con la mayor anticipación posible una consulta coordinada en caso de no poder concurrir.</p>
				    <p><strong>Los medios para hacerlo son:</strong></p>
				    <ul>
				      <li><span>&#8226;</span>Respuesta al mensaje recordatorio de consulta 
			          por SMS</li>
				      <li><span>&#8226;</span>Envío de mail a <a href="mailto:coordinacion@mp.com.uy" style="color:#ec880b">coordinacion@mp.com.uy</a></li>
				      <li><span>&#8226;</span>Telefónicamente al 2711 1000 Opción 2</li>
				      </ul>
                    </div><!-- content text -->		
			</div><!-- content page -->
