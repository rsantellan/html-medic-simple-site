...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/eventos_smart-talent-day.jpg" class="images_top">
					<div class="content_text">
					  <h1>Smart talent day</h1>	
					  <p>Medicina Personalizada invita a sus socios a participar del Smart Talent Day, evento organizado por Uruguay XXI dirigido a estudiantes y profesionales que quieran impulsar su talento para trabajar desde Uruguay hacia el mundo. </p>
					  <p>Se realizará el sábado 3 de setiembre de 15 a 22 hs. en Kibón Avanza. </p>
					  <p>					    Inscripciones sin costo en 
					    <a href="http://www.smarttalent.uy/day" target="_blank">www.smarttalent.uy/day</a></p>
              </div>
					<!-- content text -->		
			</div><!-- content page -->
