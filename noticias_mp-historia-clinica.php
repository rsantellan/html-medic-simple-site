...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="images/noticias_mp-historia-clinica.jpg" class="images_top">
					<div class="content_text">
				    <h1>Seguridad de la información</h1>
            <p>Medicina Personalizada trabaja continuamente en sus procesos buscando la mejora continua de los mismos.</p>
            <p>Desde hace varios meses nuestro foco está puesto en la seguridad de la información y hemos considerado conveniente solicitar a nuestros socios que al momento de recepcionarse presenten su documento de identidad, ya que el mismo es único e irrepetible.</p>
            <p>Agradecemos vuestra comprensión, nuestra prioridad siempre es cuidarlos y saber que su información está segura.</p>
          </div>
					<!-- content text -->		
