...
<div class="wrapper">
 	<div class="content">
			...
			<iframe src="http://www.mp.com.uy/frontend51/page?1,sitio-principal,mp-mp-login,O,es,0," class="login" id="view_large"></iframe>
			<iframe src="http://www.mp.com.uy/frontend51/page?1,sitio-principal,mp-mp-login3,O,es,0," class="login" id="view_medium_large"></iframe>
			<iframe src="http://www.mp.com.uy/frontend51/page?1,sitio-principal,mp-mp-login7,O,es,0," class="login" id="view_small"></iframe>
			<!--<div class="login">
			        ...
			        <div class="flexslider">
			          <ul class="slides">
                            ...
                            <li><a href="/noticias_ampliacion-golf.php"><img src="images/slide2.jpg" /></a></li>
			  	    		<li><a href="/eventos_mama-mp.php"><img src="images/slide-mamamp.jpg" /></a></li>		
		  	    		...
		  	    		<!--<li><a href="http://www.mp.com.uy/instagram/" target="blank"><img src="images/slide1.jpg" /></a></li>
			...
			<div class="block_home_img">
				...
				<div class="block_text">
					<h3>Tos Convulsa</h3>
					<p>La tos convulsa es una enfermedad infecciosa respiratoria, aguda, altamente contagiosa.</p>
					<a href="articulos_tos-convulsa.php">Ver m&aacute;s</a>
				</div>
			</div><!-- block home -->
        ...
        <!-- REDES SMARTPHONE -->
          <div class="redes_content">
            <ul class="redes">
              <li><a href="http://www.mp.com.uy/frontend51/page?1,sitio-principal,mp--mi-pagina-mp,O,es,0,"><img src="/images/mi_mp.jpg"></a></li>
