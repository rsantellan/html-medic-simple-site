...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/eventos_giselle.jpg" class="images_top">
					<div class="content_text">
					  <h1>Giselle. Sorteamos entradas dobles</h1>	
					  <p>Mp y el ballet del Sodre se unieron a beneficio de Niños con Alas. <br>
					    Función preestreno de Giselle.<br>
					  </p>
<p>Función: Jueves 28 de Mayo<br>
  Anfiteatro del Auditorio Nacional Adela Reta<br>
  Sorteo: Jueves 21 de Mayo</p>
<p>Inscripciones en <a href="/frontend51/page?1,sitio-principal,mp--mi-pagina-mp,O,es,0,">MI MP </a>para participar.</p>
			  </div>
					<!-- content text -->		
			</div><!-- content page -->
