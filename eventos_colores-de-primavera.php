...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/eventos_colores-primavera.jpg" class="images_top">
					<div class="content_text">
					  <h1>Colores de primavera</h1>	
					  <p>Invitamos a nuestros pequeños socios a participar en una actividad de plástica el miércoles 21 de setiembre de 15:00 a 16:30 en la Clínica Golf.</p>
					  <p>Los cupos son limitados, por lo que quienes deseen inscribir a sus niños deben hacerlo antes del 12 de setiembre enviando un correo a <a href="mailto:eventos@mp.com.uy">eventos@mp.com.uy</a> con sus datos.</p>
					  <p><strong>Clínica Golf:</strong> Bvar Artigas 499</p>
              </div>
					<!-- content text -->		
			</div><!-- content page -->
