...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="images/noticias_mp-ingreso-inclusivo.jpg" class="images_top">
					<div class="content_text">
				    <h1>Ingreso inclusivo en nuestras clínicas</h1>
            <p>Recordamos a nuestros socios los accesos para silla de rueda, coches de bebé o personas con dificultad de movilidad en nuestras Clínicas:</p>
            <ul>
              <li><span>&#8226;</span>Clínica Carrasco: Rampa por Puntas de Santiago</li>
              <li><span>&#8226;</span>Clínica Setiembre y Consultorios Parque Batlle: Acceso por Prudencio de Pena</li>
              <li><span>&#8226;</span>Clínica Golf: Acceso por Benito Nardone</li>
              <li><span>&#8226;</span>Casa Central: Acceso por Av. Ricaldoni</li>
              <li><span>&#8226;</span>Consultorios Médicos Roosevelt: Rampa por Avenida Roosevelt</li>
            </ul>
          </div>
					<!-- content text -->		
