		...
		function ShowMediaManager()
		{
			...
			if($_SESSION["rp"] == "")
			{
				...
				$sPath = eregi_replace("/{2,}", "/", $sPath);
                        	...
                        	// Get the path of the GXportal insert images dialog
                        	$GXPInsertImageDialog = $_SESSION['GXPBackendPath']."/hctse006?,,IMAGE,0,3,27,T,".$_SESSION['LngId'];
                        	if ($_SESSION['CallerType'] == "D")
                        		$GXPInsertImageDialog = $_SESSION['GXPBackendPath']."/hnmse005".$_SESSION['pgmExtension']."?,,1,26,E,".$_SESSION['LngId'];
                        	if ($_SESSION['CallerType'] == "W")
                        		$GXPInsertImageDialog = $_SESSION['GXPBackendPath']."/hctse006".$_SESSION['pgmExtension']."?,,IMAGE,0,90,0,T,".$_SESSION['LngId'].",".$_SESSION['CTConTypId'];
                        	if ($_SESSION['CallerType'] == "C")
                        		$GXPInsertImageDialog = $_SESSION['GXPBackendPath']."/hctse006".$_SESSION['pgmExtension']."?,,IMAGE,0,3,27,T,".$_SESSION['LngId'].",".$_SESSION['CTConTypId'];
                        	if ($_SESSION['CallerType'] == "F")
                        		$GXPInsertImageDialog = $_SESSION['GXPBackendPath']."/hctse006".$_SESSION['pgmExtension']."?,,IMAGE,0,91,1,T,".$_SESSION['LngId'].",".$_SESSION['CTConTypId'];
		...
		?>
			...
			<head>
				...
				<script type="text/javascript">
                        	...
                        	{
                        		document.location.href = '<?php echo $GXPInsertImageDialog ?>';
                        	}
                        	else
                        	{
                        		self.resizeTo(350,510);
                        	}
			...
			<body style="background-color: #EAE8E4" onLoad="Tab(<?php echo $tab; ?>)">
				...
				<div id="imageBox" class="box">
					...
					<div style="width: 260px; margin: -10px 0px -10px 15px; background-color: #F4F4F4; height: 23px; display:none"><img src="images/sep1.gif" height="20">
