...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="/images/noticias_factura-por-email.jpg" class="images_top">
					<div class="content_text">
						<h1>Factura por e-mail</h1>	
						<p>Le recordamos que puede solicitar que su factura le sea enviada por e-mail mandando un correo a <a href="mailto:facturacion@mp.com.uy">facturacion@mp.com.uy</a>.</p>
						<p>Es necesario que detalle los socios que están activos en el grupo familiar y el e-mail específico al que quiere recibir la copia de la factura.</p>
						<p>Reduciendo el uso de papel colaboramos con el medio ambiente.</p>
	          </div><!-- content text -->		
	  </div><!-- content page -->
