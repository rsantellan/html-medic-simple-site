...
<div class="wrapper">
 	<div class="content">
			...
			<div class="content_page">
				<img src="images/noticias_mp-nuevo-parking.jpg" class="images_top">
					<div class="content_text">
				    <h1>Nuevo parking</h1>
            <p>En el correr del mes de agosto quedará habilitado el ingreso por Prudencio de Pena a nuestro estacionamiento de Clínica Setiembre y Consultorios Parque Batlle.</p>
            <p>Recordamos que al momento de recepcionarse, los usuarios deberán sellar su ticket realizando el pago al momento de retirarse, en la recepción de Consultorios Parque Batlle (al fondo de la cafetería).</p>
          </div>
					<!-- content text -->		
